...
<link rel="stylesheet" href="{{secure_asset('css/select2-bootstrap.min.css')}}">
<!--daterangepicker-->
<link rel="stylesheet" href="{{secure_asset('css/bootstrap-datepicker.min.css')}}">
<!--bootstrap toggle-->
<link rel="stylesheet" href="{{secure_asset('css/bootstrap-toggle.min.css')}}">
<!--Custom theme styles-->
...
<!--bootstrap switch-->
<script type="text/javascript" src="{{secure_asset('js/bootstrap-toggle.min.js')}}"></script>
