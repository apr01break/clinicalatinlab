...
@section('title-right')
<div>
  <a href="{{route('descuentos.create')}}" class="btn btn-primary">Crear tipo Descuento</a>
</div>
@endsection
      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="" method="post">
          <p class="text-muted font 13 m-b-30">
            Bienvenido a la seccion de incentivos, aqui podra registrar, visualizar, actualizar o eliminar un descuento.
          </p>
                ...
                <table id="t_data_tables" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><a href="{{route('descuentos.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
...
@include('admin.descuentos.destroy')
@endsection
