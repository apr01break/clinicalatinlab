...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Registros de solicitudes</h2>
      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="" method="post">
          <p class="text-muted font 13 m-b-30">
            Bienvenido a la seccion de solicitudes, aqui podra registrar, visualizar, actualizar o eliminar un paciente.
          </p>
                ...
                <table id="t_data_tables" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>00005</td>
                      <td>23/10/1997</td>
                      <td>Carlos Bernal Gambo</td>
                      <td>Ecografia ginecologica</td>
                      <td>Laboratorio</td>
                      <td>Solicitado</td>
                      <td><a href="{{route('solicitudes.show')}}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i></a>
                          <a href="{{route('solicitudes.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
...
@include('admin.solicitudes.destroy')
@endsection
