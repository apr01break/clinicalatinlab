...
@section('title-right')
<div>
  <a href="{{route('medidas.create')}}" class="btn btn-primary">Crear Unidad de medida</a>
</div>
@endsection
      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="" method="post">
          <p class="text-muted font 13 m-b-30">
            Bienvenido a la seccion de administracion de unidades de medida, aqui podra registrar, visualizar, actualizar o eliminar una unidad de medida.
          </p>
            ...
            <div class="row">
              <div class="table-responsive">
                <table id="t_data_tables" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      <td>FCO x 30 TABLETA</td>
                      <td><a href="{{route('medidas.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#bs-delete-modal-lg"><i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <tr>
                      <td>TIRA x 4 TABLETA</td>
                      <td><a href="{{route('medidas.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#bs-delete-modal-lg"><i class="fa fa-close"></i></a>
                      </td>
                    </tr>
