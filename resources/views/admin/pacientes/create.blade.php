  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="{{route('pacientes.store')}}" id="frm-create" method="post">
          ...
          <div class="form-group">
            <div class="col-md-3 col-sm-4 col-xs-12">
                ...
                <input type="text" class="form-control" name="prNombre" required>
            </div>
            <div class="col-md-3 col-sm-4 col-xs-12">
                <label for="sgNombre">Segundo Nombre</label>
                <input type="text" class="form-control" name="sgNombre">
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="input-group">
                  <input type="text" name="fechaNacimiento" class="dtp1 form-control has-feedback-left" data-date-end-date="0d" required>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
              ...
              <div class="input-group">
                <input type="checkbox" class="bts-togg" value="true" name="discapacitado"  data-on="Si" data-off="No"/>
              </div>
            </div>
          ...
          <div class="form-group">
            <div class="col-md-2 col-sm-2 col-xs-12">
                ...
                <select class="form-control" name="tipoDocum" required>
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
                ...
                <input type="text" name="nroDocum" class="form-control" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
            </div>
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
                ...
                <input type="text" name="nroDirecc" class="form-control" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-12">
                <label for="intDirecc">Interior</label>
                <input type="text" name="intDirecc" class="form-control" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
            </div>
            <div class="col-md-1 col-sm-1 col-xs-12">
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
                ...
                <input type="text" name="lotDirecc" class="form-control" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-3 col-sm-3 col-xs-12">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <select class="form-control" name="tipoLocali">
            ...
            <div class="col-md-1 col-sm-1 col-xs-12">
              ...
              <div class="input-group">
                <input type="checkbox" class="bts-togg" value="true" name="veterinaria"  data-on="Si" data-off="No"/>
              </div>
            </div>
