        ...
        <form class="form-horizontal form-label-left" action="" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <input type="text" name="contacto" class="form-control" value="">
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <label for="grupo">Grupo</label>
                <input type="text" name="grupo" class="form-control" value="">
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <label for="atencion">Atención</label>
                <input type="text" name="atencion" class="form-control" value="">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="input-group">
                    <input type="text" name="fechaConsti" class="dtp1 form-control has-feedback-left" data-date-end-date="0d">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="input-group">
                    <input type="text" name="fechaAniver" class="dtp1 form-control has-feedback-left" data-date-end-date="0d">
                    <span class="fa fa-calendar-o form-control-feedback left"></span>
                </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="input-group input-group-sm">
                    <select class="form-control special2" style="width: 100%;" name="distrito_id" required>
                        <option value=""></option>
          ...
          <div class="form-group">
            <div class="col-md-3 col-sm-3 col-xs-12">
                ...
                <input type="text" name="anexo" class="form-control" value="">
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12">
