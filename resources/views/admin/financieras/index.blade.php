...
@section('title-right')
<div>
  <a href="{{route('financieras.create')}}" class="btn btn-primary">Crear razon</a>
</div>
@endsection
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Registros de Razones financieras</h2>
      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="" method="post">
          <p class="text-muted font 13 m-b-30">
            Bienvenido a la seccion de administracion de razones financieras, aqui podra registrar, visualizar, actualizar o eliminar un paciente.
          </p>
            ...
            <div class="row">
              <div class="table-responsive">
                <table id="t_data_tables" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <tr>
                      <td>Pago por servicios de examenes</td>
                      <td>Ingreso</td>
                      <td><a href="{{route('financieras.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#bs-delete-modal-lg"><i class="fa fa-close"></i></a>
                      </td>
                    </tr>
                    <tr>
                      <td>Pago al personal</td>
                      <td>Egreso</td>
                      <td><a href="{{route('financieras.update')}}" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
                          <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#bs-delete-modal-lg"><i class="fa fa-close"></i></a>
                      </td>
...
@include('admin.financieras.destroy')
@endsection
