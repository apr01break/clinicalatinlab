      ...
      <div class="x_content" style="display: block;">
        <form class="form-horizontal form-label-left" action="" method="post">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12">
              ...
              <input type="text" name="nombre" class="form-control" value="Glucosa" required>
          </div>
          <div class="col-md-4 col-sm-4 col-xs-12">
              <label for="descripcion">Código</label>
              <input type="text" name="codigo" class="form-control" value="W4241325D" required>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
              ...
              <div class="input-group">
                  <input type="text" name="fechaProduccion" value="17/04/2016" class="form-control has-feedback-left" data-date-end-date="0d" required>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
              ...
              <div class="input-group">
                  <input type="text" name="fechaVencimiento" value="30/12/2017" class="form-control has-feedback-left" data-date-end-date="0d" required>
                  <span class="fa fa-calendar-o form-control-feedback left"></span>
              </div>
          </div>
        </div>
